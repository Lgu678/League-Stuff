...
public:
	...
	AudioWrapper*		getAudio()				{ return audio;								}
	...
	void	shutdown();
	void	startGame();
	void	setCenterScreen(bool CENTER_SCREEN) { _CENTER_SCREEN = CENTER_SCREEN; }
	bool	getCenterScreen() { return _CENTER_SCREEN; }
	Hud* getHud() { return hud; }
	void initializeHud() { hud = new Hud(); }
};