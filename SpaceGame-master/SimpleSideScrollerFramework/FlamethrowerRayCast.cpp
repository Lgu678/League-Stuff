...
FlamethrowerRayCast::FlamethrowerRayCast()
{
}
...
float FlamethrowerRayCast::ReportFixture(b2Fixture* fixture, const b2Vec2& point, const b2Vec2& normal, float fraction)
{
